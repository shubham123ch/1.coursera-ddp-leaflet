/*
 ...
 @preserve
*/
'use strict'; (function (f, m) { "object" === typeof exports && "undefined" !== typeof module ? module.exports = m() : "function" === typeof define && define.amd ? define(m) : (f = f || self, f.WMSCapabilities = m()) })(this, function () {
    function f(a) { return void 0 !== a } function m(a, c, b) { if (a.nodeType === u.CDATA_SECTION || a.nodeType === u.TEXT) c ? b.push(String(a.nodeValue).replace(/(\r\n|\r|\n)/g, "")) : b.push(a.nodeValue); else for (a = a.firstChild; a; a = a.nextSibling)m(a, c, b); return b } function F(a) {
        for (a = a.nextElementSibling || a.nextSibling; a &&
            a.nodeType !== u.ELEMENT;)a = a.nextSibling; return a
        ...
        return function (d, e) {
            var n = a.call(f(b) ? b :
                this, d, e); f(n) && (e = e[e.length - 1], d = f(c) ? c : d.localName, e[d] = n)
        }
        ...
        if (a = /^\s*(\d+)\s*$/.exec(a)) return parseInt(a[1],
            10)
    } function e(a) { return m(a, !1, []).join("").replace(G, "") } function x(a) { return a.getAttributeNS("http://www.w3.org/1999/xlink", "href") } function B(a) { return [p(a.getAttribute("minx")), p(a.getAttribute("miny")), p(a.getAttribute("maxx")), p(a.getAttribute("maxy"))] } function q(a, c) { return l({}, H, a, c) } function y(a, c) { return l({}, I, a, c) } function C(a, c) { c = q(a, c); if (f(c)) return a = [v(a.getAttribute("width")), v(a.getAttribute("height"))], c.size = a, c } function D(a, c) { return l([], J, a, c) } var u = {
        ELEMENT: 1, ATTRIBUTE: 2,
        TEXT: 3, CDATA_SECTION: 4, ENTITY_REFERENCE: 5, ENTITY: 6, PROCESSING_INSTRUCTION: 7, COMMENT: 8, DOCUMENT: 9, DOCUMENT_TYPE: 10, DOCUMENT_FRAGMENT: 11, NOTATION: 12
    }, z = function (a) { this._parser = new a }; z.prototype.toDocument = function (a) { return this._parser.parseFromString(a, "application/xml") }; z.prototype.getAllTextContent = function (a, c) { return m(a, c, []).join("").join("") }; var G = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, g = [null, "http://www.opengis.net/wms"], M = h(g, {
        Service: b(function (a, c) { return l({}, K, a, c) }), Capability: b(function (a,
            c) { return l({}, L, a, c) })
        ...
        ContactPersonPrimary: b(function (a, c) {
            return l({}, Q, a,
                c)
        }), ContactPosition: b(e), ContactAddress: b(function (a, c) { return l({}, R, a, c) }), ContactVoiceTelephone: b(e), ContactFacsimileTelephone: b(e), ContactElectronicMailAddress: b(e)
        ...
        Name: b(e), Title: b(e), Abstract: b(e), KeywordList: b(D), CRS: k(e), SRS: k(e), EX_GeographicBoundingBox: b(function (a, c) {
            var b = l({}, S, a, c); if (f(b)) {
                a = b.westBoundLongitude;
                c = b.southBoundLatitude; var d = b.eastBoundLongitude; b = b.northBoundLatitude; if (f(a) && f(c) && f(d) && f(b)) return [a, c, d, b]
            }
